...
public class UserAuthInfo {
    ...
    public UserAuthInfo addApiAuth(String requestUrl, String requestMethod) {
        apiAuthSet.add(new ApiAuth(requestUrl,requestMethod));
        return this;
    }
    ...
    @Accessors(chain = true)
    class ApiAuth{
        public ApiAuth(String requestUrl, String requestMethod) {
        ...
        public boolean equals(Object o) {
            ...
            return requestUrl.equals(apiAuth.requestUrl) &&
                    requestMethod.equals(apiAuth.requestMethod);
        }

        @Override
        public int hashCode() {
            return Objects.hash(requestUrl, requestMethod);
        }
    }
    @Getter
    @Accessors(chain = true)
